...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col items-center justify-center overflow-hidden bg-slate-400 dark:bg-slate-950 w-full rounded-md z-0 min-h-screen md:-mt-48",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] dark:bg-gradient-conic dark:from-cyan-500 dark:via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent dark:to-cyan-500 text-white [--conic-position:from_290deg_at_center_top]"
        >
      ...
      <div className="relative z-50 flex lg:-translate-y-32 -translate-y-72 flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
