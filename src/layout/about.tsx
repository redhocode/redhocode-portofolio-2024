...
export default function About() {
  ...
  return (
    <section id="about" className="pt-5 bg-gray-300 dark:bg-slate-900">
      <div className="container flex flex-col mx-auto md:flex-row md:items-center py-5">
        <div className="w-full px-4 md:w-1/2 lg:w-1/2">
          ...
          <p className="text-justify">
            {t("im")} &nbsp;
            <span className="font-semibold dark:text-slate-50 text-xl">
              {t("name")}
            </span>
            <br />
            {t("desc")}
